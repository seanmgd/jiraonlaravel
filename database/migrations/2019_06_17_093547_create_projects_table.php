...
class CreateProjectsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('projects', function (Blueprint $table) {
            ...
            //Clef etrangère pour referencer l'owned_id a l'id de la table user, le onDelete cascade permet de supprimer la valeur si l'utilisateur supprime son compte
